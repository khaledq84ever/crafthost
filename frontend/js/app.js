...
window.I18N = {
  en: {
    // Navigation
    nav_servers: 'Servers', nav_plugins: 'Plugins', nav_files: 'Files', nav_console: 'Console', nav_settings: 'Settings', nav_jars: 'JAR Library', nav_account: 'Account',
    // Common actions
    sign_in: 'Sign in', sign_up: 'Sign up', sign_out: 'Sign out', create_server: 'Create Server',
    start: 'Start', stop: 'Stop', restart: 'Restart', delete: 'Delete', cancel: 'Cancel', save: 'Save', apply: 'Apply', loading: 'Loading…', confirm: 'Confirm', back: 'Back', next: 'Next', upload: 'Upload', download: 'Download', edit: 'Edit', search: 'Search', install: 'Install', refresh: 'Refresh', send: 'Send', copy: 'Copy', close: 'Close',
    // Status
    online: 'Online', offline: 'Offline', starting: 'Starting…', stopped: 'Stopped',
    // Stats
    players: 'Players', uptime: 'Uptime', cpu: 'CPU', ram: 'RAM', tps: 'TPS', address: 'Address', mc_version: 'MC version', host_port: 'Host port', exit_code: 'Exit code', msPT: 'MSPT',
    // Landing page
    hero_title: 'Your Minecraft Server.', hero_title_line2: 'Live in 60 Seconds.',
    hero_sub: 'Deploy vanilla, modded, or custom-JAR servers in a click. Real hardware. Zero throttling. DDoS-protected.',
    hero_sub_free: 'Deploy vanilla, modded, or custom-JAR Minecraft servers in one click. Completely free.',
    hero_cta_trial: 'Start Free 7-Day Trial →', hero_cta_plans: 'View Plans',
    hero_cta_deploy: 'Deploy My Server →', hero_cta_pricing: 'View pricing',
    landing_systems_ok: 'All systems operational · 99.98% uptime',
    landing_stats_servers: 'Servers Online Now', landing_stats_players: 'Players Connected', landing_stats_tps: 'Average TPS', landing_stats_host: 'Public Join Address',
    landing_live_badge: '🟢 Live Right Now', landing_live_title: 'Real servers, real players', landing_live_sub: 'Every card below is an actual Minecraft server running on CraftHost. Click Copy and paste into your client.',
    landing_features_badge: 'Features', landing_features_title: 'Everything you need to run a thriving server.', landing_features_sub: 'Built on bare metal. Tuned for low MSPT. Designed for builders, not bureaucrats.',
    landing_pricing_badge: 'Pricing', landing_pricing_title: 'Plans that scale with your community.',
    landing_faq_badge: 'FAQ', landing_faq_title: 'Common questions, straight answers.',
    // Dashboard
    welcome_back: 'Welcome back',
    your_servers: 'Your Servers',
    manage_sub: 'Manage your Minecraft servers, plugins, and worlds.',
    stat_active: 'Active servers', stat_players_online: 'Players online', stat_avg_tps: 'Avg. TPS', stat_plan: 'Plan',
    health_check: 'Health Check',
    quick_deploy: '⚡ Quick Deploy', quick_deploy_sub: 'Click any template to spin up a pre-configured server in seconds — no wizard.',
    qd_survival: 'Survival', qd_creative: 'Creative', qd_skyblock: 'Skyblock', qd_modded: 'Modded',
    // Auth pages
    auth_email: 'Email', auth_password: 'Password', auth_username: 'Username',
    auth_signin_title: 'Welcome back', auth_signin_sub: 'Sign in to your CraftHost account',
    auth_signup_title: 'Create your account', auth_signup_sub: 'Start hosting in 60 seconds',
    auth_forgot: 'Forgot password?', auth_no_account: "Don't have an account?", auth_have_account: 'Already have an account?',
    auth_remember: 'Keep me signed in for 30 days',
    auth_reset_title: 'Reset password',
    // Marketplace
    market_title: 'Plugins & Mods', market_sub: '200,000+ from Modrinth & CurseForge. One-click install on your server.',
    market_featured: '🔥 Featured Modpacks', market_featured_sub: 'Live from Modrinth',
    market_top_picks: '⭐ Top Plugins · One-Click', market_top_sub: 'Curated by CraftHost · paper/spigot/purpur',
    market_all: 'All Plugins & Mods',
    market_search_ph: 'Search 200,000+ plugins & mods...',
    market_load_more: 'Load more →',
    // Files
    files_title: 'File Manager', files_sub: 'Browse, edit, upload, and download files inside your server.',
    files_new_folder: 'New folder', files_upload_btn: 'Upload',
    files_settings_tab: 'Settings', files_backups_tab: 'Backups', files_files_tab: 'Files',
    // Console
    console_title: 'Live Console',
    console_send_ph: 'Type a command and press Enter...',
    // Billing
    billing_title: 'Billing & Plan',
    billing_balance: 'Balance', billing_plan: 'Current plan', billing_invoices: 'Invoices',
    // Settings page
    settings_title: 'Account Settings', settings_change_password: 'Change password',
    settings_delete_account: 'Delete account',
    // JAR Library
    jars_title: 'JAR Library', jars_sub: 'Your custom JARs and the latest official builds.',
    // Footer / Chrome
    footer_credit: 'Programmed by',
    free_plan: 'Free', upgrade: 'Upgrade',
    // Pricing page
    nav_features: 'Features', nav_pricing: 'Pricing', nav_faq: 'FAQ',
    get_started: 'Get Started', open_dashboard: 'Dashboard', home: 'Home',
    pricing_title: 'Simple, transparent pricing.',
    pricing_sub: 'All plans include DDoS protection, automatic backups, NVMe storage, and 24/7 support.',
    start_free: 'Start free', choose: 'Choose', popular: 'Popular',
    feature: 'Feature', cpu_cores: 'CPU cores', nvme: 'NVMe storage',
    player_slots: 'Player slots', plugin_slots: 'Plugin slots',
    backup_retention: 'Backup retention', backup_interval: 'Backup interval',
    custom_jar: 'Custom JAR upload', dedicated_ip: 'Dedicated IP',
    priority_support: 'Priority support', ddos: 'DDoS protection', bedrock_java: 'Bedrock & Java',
  },
  ar: {
    nav_servers: 'السيرفرات', nav_plugins: 'الإضافات', nav_files: 'الملفات', nav_console: 'الكونسول', nav_settings: 'الإعدادات', nav_jars: 'مكتبة JAR', nav_account: 'الحساب',
    sign_in: 'تسجيل الدخول', sign_up: 'إنشاء حساب', sign_out: 'تسجيل الخروج', create_server: 'إنشاء سيرفر',
    start: 'تشغيل', stop: 'إيقاف', restart: 'إعادة', delete: 'حذف', cancel: 'إلغاء', save: 'حفظ', apply: 'تطبيق', loading: 'جارٍ التحميل…', confirm: 'تأكيد', back: 'رجوع', next: 'التالي', upload: 'رفع', download: 'تنزيل', edit: 'تعديل', search: 'بحث', install: 'تثبيت', refresh: 'تحديث', send: 'إرسال', copy: 'نسخ', close: 'إغلاق',
    online: 'متصل', offline: 'متوقف', starting: 'يبدأ التشغيل…', stopped: 'متوقف',
    players: 'اللاعبون', uptime: 'مدة التشغيل', cpu: 'المعالج', ram: 'الذاكرة', tps: 'TPS', address: 'العنوان', mc_version: 'إصدار اللعبة', host_port: 'منفذ الاتصال', exit_code: 'كود الخروج', msPT: 'MSPT',
    hero_title: 'سيرفر ماين كرافت الخاص بك.', hero_title_line2: 'جاهز خلال ٦٠ ثانية.',
    hero_sub: 'انشر سيرفرات فانيلا أو مودات أو JAR مخصص بضغطة. أجهزة حقيقية، بدون اختناقات، حماية من DDoS.',
    hero_sub_free: 'انشر سيرفرات ماين كرافت — فانيلا أو مودات أو JAR مخصص — بضغطة واحدة. مجاناً تماماً.',
    hero_cta_trial: 'ابدأ تجربة مجانية ٧ أيام ←', hero_cta_plans: 'عرض الخطط',
    hero_cta_deploy: 'انشر سيرفري ←', hero_cta_pricing: 'عرض الأسعار',
    landing_systems_ok: 'كل الأنظمة تعمل · جاهزية ٩٩.٩٨٪',
    landing_stats_servers: 'سيرفرات تعمل الآن', landing_stats_players: 'لاعبون متصلون', landing_stats_tps: 'متوسط TPS', landing_stats_host: 'عنوان الانضمام العام',
    landing_live_badge: '🟢 يعمل الآن', landing_live_title: 'سيرفرات حقيقية، لاعبون حقيقيون', landing_live_sub: 'كل كرت بالأسفل هو سيرفر ماين كرافت فعلي يعمل على CraftHost. اضغط نسخ وألصقه في عميل اللعبة.',
    landing_features_badge: 'المميزات', landing_features_title: 'كل ما تحتاجه لإدارة مجتمع ناجح.', landing_features_sub: 'مبني على أجهزة فعلية. مضبوط لأداء MSPT منخفض.',
    landing_pricing_badge: 'الخطط', landing_pricing_title: 'خطط تنمو مع مجتمعك.',
    landing_faq_badge: 'الأسئلة الشائعة', landing_faq_title: 'أسئلة شائعة وإجابات مباشرة.',
    welcome_back: 'مرحباً بعودتك',
    your_servers: 'سيرفراتك',
    manage_sub: 'أدر سيرفرات ماين كرافت والإضافات والعوالم.',
    stat_active: 'السيرفرات النشطة', stat_players_online: 'اللاعبون المتصلون', stat_avg_tps: 'متوسط TPS', stat_plan: 'الخطة',
    health_check: 'فحص الحالة',
    auth_email: 'البريد الإلكتروني', auth_password: 'كلمة المرور', auth_username: 'اسم المستخدم',
    auth_signin_title: 'مرحباً بعودتك', auth_signin_sub: 'سجّل دخولك إلى حساب CraftHost',
    auth_signup_title: 'أنشئ حسابك', auth_signup_sub: 'ابدأ الاستضافة خلال ٦٠ ثانية',
    auth_forgot: 'نسيت كلمة المرور؟', auth_no_account: 'لا تملك حساباً؟', auth_have_account: 'تملك حساباً بالفعل؟',
    auth_remember: 'إبقني مسجلاً ٣٠ يوماً',
    auth_reset_title: 'إعادة تعيين كلمة المرور',
    market_title: 'الإضافات والمودات', market_sub: 'أكثر من ٢٠٠ ألف من Modrinth و CurseForge. تثبيت بضغطة على سيرفرك.',
    market_featured: '🔥 مودباكس مميزة', market_featured_sub: 'مباشرة من Modrinth',
    market_top_picks: '⭐ أفضل الإضافات · تثبيت بضغطة', market_top_sub: 'مختارة من CraftHost · paper/spigot/purpur',
    market_all: 'كل الإضافات والمودات',
    quick_deploy: '⚡ نشر سريع', quick_deploy_sub: 'اضغط على أي قالب لتشغيل سيرفر جاهز خلال ثوانٍ — بدون معالج.',
    qd_survival: 'البقاء', qd_creative: 'الإبداع', qd_skyblock: 'سكاي بلوك', qd_modded: 'مودات',
    market_search_ph: 'ابحث في أكثر من ٢٠٠ ألف إضافة ومود...',
    market_load_more: 'تحميل المزيد ←',
    files_title: 'مدير الملفات', files_sub: 'تصفّح وعدّل وارفع وحمّل الملفات داخل سيرفرك.',
    files_new_folder: 'مجلد جديد', files_upload_btn: 'رفع',
    files_settings_tab: 'الإعدادات', files_backups_tab: 'النسخ الاحتياطية', files_files_tab: 'الملفات',
    console_title: 'الكونسول المباشر',
    console_send_ph: 'اكتب أمراً واضغط Enter...',
    billing_title: 'الفواتير والخطة',
    billing_balance: 'الرصيد', billing_plan: 'الخطة الحالية', billing_invoices: 'الفواتير',
    settings_title: 'إعدادات الحساب', settings_change_password: 'تغيير كلمة المرور',
    settings_delete_account: 'حذف الحساب',
    jars_title: 'مكتبة JAR', jars_sub: 'ملفات JAR المخصصة وأحدث الإصدارات الرسمية.',
    footer_credit: 'برمجة',
    free_plan: 'مجاني', upgrade: 'ترقية',
    nav_features: 'المميزات', nav_pricing: 'الأسعار', nav_faq: 'الأسئلة الشائعة',
    get_started: 'ابدأ الآن', open_dashboard: 'لوحة التحكم', home: 'الرئيسية',
    pricing_title: 'أسعار بسيطة وواضحة.',
    pricing_sub: 'كل الخطط تتضمن حماية DDoS ونسخاً احتياطية تلقائية وتخزين NVMe ودعماً ٢٤/٧.',
    start_free: 'ابدأ مجاناً', choose: 'اختر', popular: 'الأكثر شعبية',
    feature: 'الميزة', cpu_cores: 'أنوية المعالج', nvme: 'تخزين NVMe',
    player_slots: 'عدد اللاعبين', plugin_slots: 'عدد الإضافات',
    backup_retention: 'مدة حفظ النسخ', backup_interval: 'تكرار النسخ',
    custom_jar: 'رفع JAR مخصص', dedicated_ip: 'IP مخصص',
    priority_support: 'دعم ذو أولوية', ddos: 'حماية DDoS', bedrock_java: 'Bedrock و Java',
  }
};
window.t = (key) => {
...
window.applyLang = (lang) => {
  ...
  document.querySelectorAll('[data-i18n]').forEach(el => {
    ...
    if (k && window.I18N[lang] && window.I18N[lang][k]) el.textContent = window.I18N[lang][k];
  });
  document.querySelectorAll('[data-i18n-placeholder]').forEach(el => {
    const k = el.getAttribute('data-i18n-placeholder');
    if (k && window.I18N[lang] && window.I18N[lang][k]) el.setAttribute('placeholder', window.I18N[lang][k]);
  });
...
(function injectMetaAndManifest() {
  ...
  function add(tag, attrs) {
    ...
    const keyAttr = attrs.property ? 'property' : attrs.name ? 'name' : attrs.rel ? 'rel' : null;
    if (keyAttr && document.head.querySelector(`${tag}[${keyAttr}="${attrs[keyAttr]}"]`)) return;
  ...
  add('meta', { name: 'description', content: 'Free Minecraft server hosting. One-click Paper deploy in 60 seconds. Plugins, world import, custom JARs, real public IP — all free.' });
  ...
  add('meta', { property: 'og:title', content: document.title || 'CraftHost — Free Minecraft Server Hosting' });
  add('meta', { property: 'og:description', content: 'Free Minecraft server hosting. One-click Paper deploy in 60 seconds. Plugins, world import, custom JARs — all free.' });
  ...
  add('meta', { property: 'og:locale', content: (document.documentElement.lang || 'en').startsWith('ar') ? 'ar_KW' : 'en_US' });
  // Twitter card
  add('meta', { name: 'twitter:card', content: 'summary_large_image' });
  add('meta', { name: 'twitter:title', content: document.title || 'CraftHost' });
  add('meta', { name: 'twitter:description', content: 'Free Minecraft server hosting. Deploy in 60 seconds.' });
...
(function loadFonts() {
  ...
  link.id = 'ch-fonts';
  link.rel = 'stylesheet';
  link.href = 'https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Tajawal:wght@400;500;700;900&display=swap';
...
(function injectChrome() {
  ...
  ready(() => {
    ...
    if (!document.querySelector('.ch-home-btn')) {
      ...
      a.innerHTML = '<span class="brand-mark">C</span><span class="ch-home-label">CraftHost</span>';
    ...
    (function hydrateUserFromCache() {
      ...
      if (cached?.username) {
        ...
        document.querySelectorAll('[data-user-name]').forEach(el => { el.textContent = cached.username; });
        document.querySelectorAll('[data-user-email]').forEach(el => { el.textContent = cached.email || ''; });
      }
    })();
    ...
    window.isSignedIn = !!(() => {
      try { return JSON.parse(localStorage.getItem('crafthost.user') || 'null'); }
      catch { return null; }
    })();
      ...
      try {
        ...
        if (r.ok) {
          ...
          if (u?.username) {
            ...
            try { localStorage.setItem('crafthost.user', JSON.stringify(u)); } catch {}
            const signIn = document.getElementById('navSignIn');
            if (signIn) signIn.style.display = 'none';
          }
    ...
    (function injectSidebarIcons() {
      const SIDEBAR_ICONS = {
        '/dashboard.html': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>',
        '/marketplace.html': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>',
        '/files.html': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>',
        '/jars.html': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',
        '/console.html': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="4 17 10 11 4 5"/><line x1="12" y1="19" x2="20" y2="19"/></svg>',
      ...
      sideNav.querySelectorAll('a[href]').forEach(a => {
        ...
        if (href === currentPath || href === location.pathname) a.classList.add('active');
    ...
    const lang = saved || ((navigator.language || 'en').toLowerCase().startsWith('ar') ? 'ar' : 'en');
    window.applyLang(lang);
  });
})();
...
(function injectMobileNav() {
  ...
  const ICONS = {
    server:    '<svg class="mn-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="7" rx="2"/><rect x="2" y="14" width="20" height="7" rx="2"/><line x1="6" y1="6.5" x2="6.01" y2="6.5"/><line x1="6" y1="17.5" x2="6.01" y2="17.5"/></svg>',
    plugin:    '<svg class="mn-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M9 2v3M15 2v3M9 19v3M15 19v3"/><path d="M2 9h3M2 15h3M19 9h3M19 15h3"/><rect x="5" y="5" width="14" height="14" rx="2"/></svg>',
    folder:    '<svg class="mn-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h5l2 3h9a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z"/></svg>',
    package:   '<svg class="mn-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M16.5 9.4 7.55 4.24"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>',
    terminal:  '<svg class="mn-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><polyline points="4 17 10 11 4 5"/><line x1="12" y1="19" x2="20" y2="19"/></svg>',
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const HIDE_PATHS = ['/', '/index', '/login', '/register', '/forgot', '/reset', '/status', '/pricing'];
    const pathNorm = location.pathname.replace(/\.html$/, '').replace(/\/$/, '') || '/';
    ...
    nav.innerHTML = `<div class="mobile-nav-inner">${items.map(i => {
      const active = here === i.href.replace(/\.html$/, '') ? ' class="active"' : '';
    ...
    if (side && !document.querySelector('.menu-btn')) {
      ...
      if (topbar) {
        ...
        btn.style.cssText = 'display:none;font-size:18px;margin-right:8px;flex-shrink:0;';
...
window.useServerPicker = async (selectEl) => {
  ...
  try {
    ...
    if (err?.status === 401 || !window.isSignedIn) {
      demo = true;
      servers = [
        { id: 'demo-survival', name: 'Survival World (demo)', type: 'paper', version: '1.21.1', status: 'online', port: 25565 },
        { id: 'demo-creative', name: 'Creative Build (demo)', type: 'vanilla', version: '1.21', status: 'offline', port: 25566 },
      ];
    } else {
      ...
      signedIn = true;
      servers = [];
      try { window.toast?.('Could not load your servers — retrying…', 'warn'); } catch {}
    }
  }
  const empty = signedIn && servers.length === 0;
  if (empty) {
    servers = [{ id: 'no-server', name: 'No servers yet — create one in the dashboard', type: '', version: '', status: 'offline', port: 0 }];
  }
  ...
  if (selectEl) {
    selectEl.innerHTML = servers.map(s => {
      const dot = s.status === 'online' || s.status === 'starting' ? '🟢' : '🔴';
